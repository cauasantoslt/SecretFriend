...
<img src="./assets/amigo-secreto.png" align="right" heigth="10%" width="40%" style="margin: 20px 0 0 20px;">
...
Before getting started with SecretFriend, ensure your runtime environment meets the following requirements:
...
Install SecretFriend using one of the following methods:

**Build from source:**

1. Clone the SecretFriend repository:
```sh
...
### 🤖 Usage
Run SecretFriend using the following command:
